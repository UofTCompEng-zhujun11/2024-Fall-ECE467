...
public:
  ...
  public:
    ...
    smallc::ArrayTypeNode* arrTypeNode;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
  ...
  public:
    smallc::FunctionDeclNode* fcnProtoNode;
  ...
  public:
    smallc::FunctionDeclNode* fcnDeclNode;
    smallCParser::RetTypeContext *retTypeContext = nullptr;;
    smallCParser::FcnNameContext *fcnNameContext = nullptr;;
    smallCParser::ParamsContext *paramsContext = nullptr;;
  ...
  public:
    smallc::PrimitiveTypeNode* typeNode;
  ...
  public:
    smallc::ConstantExprNode* contExprNode;
  ...
  public:
    smallc::AssignStmtNode* assignStmtNode;
  ...
  public:
    smallc::WhileStmtNode* whileStmtNode;
    smallCParser::ExprContext *exprContext = nullptr;;
    smallCParser::StmtContext *stmtContext = nullptr;;
  ...
  public:
    smallc::ReturnStmtNode* retStmtNode;
    smallCParser::ExprContext *exprContext = nullptr;;
  ...
  public:
    smallc::ExprNode* exprStmtNode;
    smallc::BinaryExprNode* binaryExprNode;
    smallc::UnaryExprNode* unaryExprNode;
    smallc::CallExprNode* funcCallNode;
    smallc::IdentifierNode* funcName;
    smallc::BoolExprNode* boolexpr;
  ...
  public:
    smallc::IntExprNode* intExprNode;
    smallc::BinaryExprNode* binaryExprNode;
  ...
  public:
    smallc::ReferenceExprNode* target_;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
    smallCParser::IntExprContext *intExprContext = nullptr;;
  ...
  public:
    smallc::ParameterNode* paramEntryNode;
    smallc::ArrayTypeNode* arrTypeNode;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
  ...
  public:
    std::vector<smallc::ArgumentNode*> argsList;
  ...
  public:
    smallc::ArgumentNode* argEntryNode;
    smallCParser::ExprContext *exprContext = nullptr;;
  ...
  public:
    smallc::IdentifierNode* nameNode;
